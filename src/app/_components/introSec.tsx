  ...
  <defs>
    ...
    <div className='md:static container flex max-w-[64rem] flex-col items-center text-center gap-4'>
      ...
      <p className='max-w-[42ren] leading-normal text-muted-foreground sm:text-xl sm:leading-8'>
        ...
        technologies such as React and Node.js. My proficiency extends to creating applications 
        ranging from web to mobile, where I adeptly develop everything from RESTful APIs to dynamic 
        pages using React and React Native.
        My expertise also encompasses modern architectural patterns such as MVC 
        (Model-View-Controller), OO (Object-Oriented) principles, and OOP 
        (Object-Oriented Programming). With a commitment to innovation and staying current
        with industry trends, I bring a comprehensive skill set to every project.
      </p>
      <div className='space-x-4'>
        <a className='bg-primary py-2 px-4 text-md text-white rounded shadow-lg font-bold' 
        target="_blank"
        rel="noopener noreferrer"
        href="https://www.linkedin.com/in/whalter-duarte/">Linkedin</a>
